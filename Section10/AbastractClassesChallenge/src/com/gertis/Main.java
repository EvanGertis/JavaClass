...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // of a linked list).
        // I.e., if you call your abstract class ListItem, then it would have 2 member variable of
        ...
        // returns 0 if the values are equal, greater than zero if the value sorts greater than the parameter
        // and less than zero if it sorts less than the parameter.
        //
        ...
        // classes that we create later, but if you use names that IntelliJ recognizes as Java classes then
        // it will create imports for them and possibly cause you problems later.
        //
        // Optional: create a class to use your concrete class to implement a Binary Search Tree:
        // When adding items to a Binary Search Tree, if the item to be added is less the the current item
        ...
        //
        // Hint: to avoid typing loads of "addItem" lines, split a string into an array and create you list in a loop as in the
        // example below.
        SearchTree tree = new SearchTree(null);
        tree.traverse(tree.getRoot());

        String stringData = "5 7 6 8 9 3 0";
        String[] treearr = stringData.split(" ");
